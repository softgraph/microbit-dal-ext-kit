...
const Buttons kL		= 1 << 0;		// Button L = micro:bit Button A, or B if device::isUpsideDown() is true
const Buttons kR		= 1 << 1;		// Button R = micro:bit Button B, or A if device::isUpsideDown() is true
